...
class Livraria(nome: String, dataCriacao: String) {
    ...
    fun cadastrarLivro(codigo: Int, titulo: String, autor: String, anoLancamento: Int, precoVenda: Double,
...
class Livro(var codigo: Int, var titulo: String, var autor: String, var anoLancamento: Int,
