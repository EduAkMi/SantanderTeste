...
//
//            listaLivros.forEach {
//                if (it.codigo == consulta) {
//                    println("O livro ${it.titulo} com o código ${it.codigo} do autor ${it.autor} foi encontrado e está ${it.estadoAtual}")
//                    return@forEach
//                } else {
//                    teste = false
//                }
...
//                it.value.forEach {
//                    if (it.codigo == consulta) {
//                        println("O livro ${it.titulo} com o código ${it.codigo} que está na coleção ${colecao.keys} foi encontrado")
//                        return
//                    } else {
//                        teste = false
//                    }
...
//
//class Cliente(nome: String, rg: String, historicoAlugueis: MutableList<Livro>,
//              historicoCompras: MutableList<Livro>)
//
//class Funcionario(nome: String, rg: String, historicoAlugueis: MutableList<Livro>,
